...
def resize_and_pad(img, output_size=(1280, 720)):
    """
...
# Example usage
images_folder = r'C:\Users\dades\Music\P\faces'
output_video_path = r'C:\Users\dades\Music\P\video.mp4'
create_video(images_folder, output_video_path, fps=24)
